...
def main():
    ...
    # -------------------------------------------------------------------------
    filename_reference_12 = '../../data/rectangular-UBWT/equivalent_12_segments.json'
    filename_reference_64 = '../../data/rectangular-UBWT/similarities_64_segments.json'
    filename_equal_12 = 'equivalent_12_segments.json'
    filename_unequal_8 = 'equivalent_8_segments.json'
