...
def main():
    ...
    # -------------------------------------------------------------------------
    filename_reference_12 = '../../data/equivalent_12_segments_two_lengths.json'
    filename_reference_64 = '../../data/similarities_64_segments_two_lengths.json'
    filename_equal_12 = 'equivalent_12_segments_two_lengths.json'
    filename_unequal_8 = 'equivalent_8_segments_two_lengths.json'
